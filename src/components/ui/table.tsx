...
>(({ className, ...props }, ref) => (
  <div className="table-scroll relative w-full min-w-0 overflow-x-auto">
    <table
      ref={ref}
...
>(({ className, ...props }, ref) => (
  <tr
    ref={ref}
    className={cn(
      "hover-lift-row border-b transition-colors hover:bg-muted/50 data-[state=selected]:bg-muted",
      className,
    )}
    {...props}
  />
